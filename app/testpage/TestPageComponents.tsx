...
export const WrapSelectBtnContainer = styled.div<{ enabled: boolean }>(({ enabled }) => `
    display: grid;
    gap: 16px;
...
export const GreenButton = styled.button<{ enabled: boolean }>(({ enabled }) => `
...
export const GrayButton = styled.button<{ enabled: boolean }>(({ enabled }) => `
...
export const RedButton = styled.button<{ enabled: boolean }>(({ enabled }) => `
