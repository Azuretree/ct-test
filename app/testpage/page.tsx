...
const WrapSelectBtnContainer = styled.div<{ enabled: boolean }>(
  ({ enabled }) => `
    display: grid;
    gap: 16px;
...
const GreenButton = styled.button<{ enabled: boolean }>(
  ({ enabled }) => `
...
const GrayButton = styled.button<{ enabled: boolean }>(
  ({ enabled }) => `
...
const RedButton = styled.button<{ enabled: boolean }>(
  ({ enabled }) => `
